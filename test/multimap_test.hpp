...
/*   Updated: 2020/03/02 18:50:09 by ncolomer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_Multimap(int offset=0)
{
	std::cout << "\n---basic\n\n";
	{
		ft::Multimap<key_type, value_type> empty_map;
		{
		...
		ft::Multimap<key_type, value_type> mp;
		mp[k(5)] = 42;
		mp.insert(std::make_pair(k(5), 28));
		mp[k(9)] = 44;
		{
			std::cout << "map [5:42, 5:28, 9:44].size() = " << mp.size() << '\n';
			typename ft::Multimap<key_type, value_type>::iterator it = mp.begin();
			std::cout << "[5:42, 5:28, 9:44].[5] = " << mp[k(5)] << " (it: first: " << (*it).first << ", second: " << (*it).second << ")" << '\n';
			it = --mp.end();
			std::cout << "[5:42, 5:28, 9:44].[9] = " << mp[k(9)] << " (it: first: " << (*it).first << ", second: " << (*it).second << ")" << '\n';

			ft::Multimap<key_type, value_type> mp2 = mp;

			display_container("copied map2 [5:42, 5:28, 9:44]:", mp2);
			mp2.clear();
			display_container("cleared map2 []:", mp2);

			display_container("map [5:42, 5:28, 9:44]:", mp);
			mp.erase(k(7));
			display_container("map [5:42, 5:28, 9:44]:", mp);
			mp.erase(k(5));
	...
	std::cout << "\n---basic (bigger map)\n\n";
	{
		...
		mp.insert(std::make_pair(k(7), 7));
		mp.insert(std::make_pair(k(8), 9));
		mp.insert(std::make_pair(k(9), 9));
		mp.insert(std::make_pair(k(9), 9));
		mp.insert(std::make_pair(k(10), 10));
		mp.insert(std::make_pair(k(11), 11));

		std::cout << "size: " << mp.size() << " (9), empty? " << mp.empty() << '\n';
		display_container("map [5:5, ..., 11:11] (with duplicate):", mp);
		mp.erase(k(7));
	...
	std::cout << "\n---insert\n\n";
	{
		...
		mp.insert(mp.begin(), std::make_pair(k(5), 44));
		display_container("map [5:42, 5:44, 6:43]:", mp);

		mp.insert(--mp.end(), std::make_pair(k(3), 45));
		display_container("map [3:45, 5:42, 5:44, 6:43]:", mp);
		mp.insert(--mp.end(), std::make_pair(k(7), 46));
		display_container("map [3:45, 5:42, 5:44, 6:43, 7:46]:", mp);

		ft::Multimap<key_type, value_type> mp2;
		mp2.insert(mp.begin(), mp.end());
		display_container("map2 [3:45, 5:42, 5:44 6:43, 7:46]:", mp2);
		mp.erase(mp.begin(), mp.end());
		display_container("map cleared:", mp);
		display_container("map2 (map cleared) [3:45, 5:42, 5:44, 6:43, 7:46]:", mp2);
	}
	...
	std::cout << "\n---erase\n\n";
	{
		...
		mp.insert(std::make_pair(k(5), 43));
		mp.insert(std::make_pair(k(6), 48));
		mp.insert(std::make_pair(k(7), 44));
		mp.insert(std::make_pair(k(7), 45));
		mp.insert(std::make_pair(k(9), 46));
		display_container("map [5:42, 5:43, 6:48, 7:44, 7:45, 9:46]:", mp);

		ft::Multimap<key_type, value_type> mp2(mp);
		display_container("map2 [5:42, 5:43, 6:48, 7:44, 7:45, 9:46]:", mp2);
		...
		display_container("map2 [5:42, 5:43]:", mp2);
		mp2.erase(mp2.begin());
		display_container("map2 [5:43]:", mp2);
	...
	std::cout << "\n---find\n\n";
	{
		...
		mp.insert(std::make_pair(k(7), 44));
		mp.insert(std::make_pair(k(8), 84));
		mp.insert(std::make_pair(k(8), 88));
		...
		std::cout << "find(8) " << ((mp.find(k(8)) == --(--mp.end())) ? "== end - 2" : "!= end - 2 !!!") << '\n';
	}
	...
	std::cout << "\n---count\n\n";
	{
		...
		mp.insert(std::make_pair(k(5), 66));
		...
		display_container("map [5:42, 6:48, 7:43]:", mp);
		std::cout << "count(5) " << mp.count(k(5)) << " (3)\n";
		std::cout << "count(6) " << mp.count(k(6)) << " (2)\n";
		std::cout << "count(7) " << mp.count(k(7)) << " (2)\n";
	...
	std::cout << "\n---swap\n\n";
	{
		...
		display_container("map [5:42, 5:42, 7:43, 7:43, 9:44]:", mp);
		display_container("map2 [11:84, 11:84, 12:85, 12:85, 13:86]:", mp2);
		mp.swap(mp2);
		std::cout << "---swapped\n";
		display_container("map [11:84, 11:84, 12:85, 12:85, 13:86]:", mp);
		display_container("map2 [5:42, 5:42, 7:43, 7:43, 9:44]:", mp2);
		ft::swap(mp, mp2);
		std::cout << "---swapped\n";
		display_container("map [5:42, 5:42, 7:43, 7:43, 9:44]:", mp);
		display_container("map2 [11:84, 11:84, 12:85, 12:85, 13:86]:", mp2);
